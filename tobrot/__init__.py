...
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "tgupload@FreeTDownloader_bot")
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "unziptgupload@FreeTDownloader_bot")
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "tgzipupload@FreeTDownloader_bot")
...
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "yttgupload@FreeTDownloader_bot")
