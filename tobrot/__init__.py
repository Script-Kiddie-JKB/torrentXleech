...
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "tgupload@yg_uploaderbot")
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "unziptgupload@yg_uploaderbot")
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "tgzipupload@yg_uploaderbot")
...
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "yttgupload@yg_uploaderbot")
