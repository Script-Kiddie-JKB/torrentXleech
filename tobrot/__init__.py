...
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "tgupload@FreeTorrentLeecherBot")
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "unziptgupload@FreeTorrentLeecherBot")
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "tgzipupload@FreeTorrentLeecherBot")
...
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdl@FreeTorrentLeecherBot")
